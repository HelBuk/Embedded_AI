...
\begin{tabular}{@{}p{0.34\linewidth}p{0.63\linewidth}@{}}
  ...
  \end{tabular}
    ...
    However, the YOLOv8 and YOLOv11 are both provided by Ultralitics
...
\section{Hailo Compiler}
    ...
    Hailo compiler is needed to load user's models to the Hailo devices.
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            \item HN— 'Hailo Network': a JSON graph of the network (layers,
